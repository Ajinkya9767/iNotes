...
if(isset($_POST['btn_update'])) {
    ...
    $unit_sub_id = $row['subject_id'];
        ...
        $unit_id = $_GET['unitid'];
        $sql = "update units set unit_desc='$unit_desc', unit_sub_id='$unit_sub_id' where unit_id='$unit_id'";
        $result = mysqli_query($conn, $sql);
        if($result){
            echo '
                <div class="alert alert-success alert-dismissible fade show my-0" role="alert">
                <strong>Success!</strong> You updated unit successfully!.
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h5 class="title">Update Unit Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="unitName" disabled value="<?php echo $unit_name; ?>" name="unitName" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="card-footer">
                                        <button type="submit" id="btn_update" name="btn_update" required class="btn btn-fill btn-primary">Update Unit</button>
                                    </div>
                                <div class="row">
                            </div>
                        </div>

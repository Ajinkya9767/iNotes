              ...
              <div class="col-md-14">
                <div class="card ">
                  <div class="card-header card-header-primary">
                    <h4 class="card-title">Assignment '.$i.' : '.$subject_name.'</h4>
                  </div>
                  <div class="card-body">
                        ...
                        while($row = mysqli_fetch_assoc($result1)){
                            ...
                            echo'
                                <tr>
                                    ...
                                    <td>
                                        <a id="btn_update" name="btn_update" href="http://localhost/iNotes/admin/addassignmentfile.php?assignmentid='.$assignment_id.'&subid='.$assignment_sub_id.'" class="btn btn-primary">Add Docs</a>
                                    </td>

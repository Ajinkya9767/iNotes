...
if(isset($_GET['assignmentid']) && isset($_GET['subid'])){
  $assignment_id = $_GET['assignmentid'];
  $assignment_sub_id = $_GET['subid'];

  $sql1 = "select assignment_name from assignments where assignment_id='$assignment_id'";
  $result1 = mysqli_query($conn, $sql1);

  $row1 = mysqli_fetch_assoc($result1);
  $assignment_name = $row1['assignment_name'];
  
  $sql = "select subject_name,sub_category from subjects where subject_id='$assignment_sub_id'";
...
if(isset($_POST['btn_save']))
{
    ...
    $sql = "insert into files (file_name, file_category, file_cat_name, file_sub) values ('$filename', '$sub_category', '$assignment_name', '$subject_name')";
    $result = mysqli_query($conn, $sql);
         ...
         <div class="col-md-7">
            <div class="card">
              <div class="card-header card-header-primary">
                <h5 class="title">Add Document</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="categoryName" name="categoryName" value="<?php echo $assignment_name; ?>" disabled class="form-control" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
